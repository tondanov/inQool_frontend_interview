...
export function AnimalsDataTable<TData, TValue>({
  columns,
  data,
  handleAddAnimal,
  ...
  return (
    <div>
      <div className="flex items-center py-4 gap-4">
        ...
        <Button onClick={toggleCard}>Add New Animal</Button>
        {showCard && (
          <FormAnimal onClose={toggleCard} handleAddAnimal={handleAddAnimal} />
        )}
      </div>
...
export default AnimalsDataTable;
